document.getElementById('continente').addEventListener("change", function () {
    ...
    const select = document.querySelector('#continente');
    ...
    rec2.onreadystatechange = function () {
        if (rec2.readyState == 4 && rec2.status == 200) {
            regiao.innerHTML = "<option value='' selected hidden disable>selecione..</option>"
            ...
            for (i = 0; i < tamanho2.length; i++) {
                regiao.innerHTML += "<option value=" + tamanho2[i] + ">" + tamanho2[i] + "</option>"
            }
...
document.getElementById('regiao').addEventListener("change", function () {
    ...
    const vsel = document.getElementById('continente').value
    const select2 = document.querySelector('#regiao');
